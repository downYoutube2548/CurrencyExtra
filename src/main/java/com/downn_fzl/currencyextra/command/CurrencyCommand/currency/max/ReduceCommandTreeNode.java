...
public class ReduceCommandTreeNode extends CommandTreeNode {
    public ReduceCommandTreeNode(CommandTreeNode parent) {
        super(parent, "reduce");
    }
        ...
        try {
            if (args.length >= 2) {
                ...
                if (target != null) {
                    ...
                    playerData.reduceMaxBalance(currency, amount);
                    sender.sendMessage(Utils.getMessage("max-reduce-success", true)
